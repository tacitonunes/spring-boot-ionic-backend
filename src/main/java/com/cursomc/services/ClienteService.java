...
public class ClienteService {
	...
	public void delete(Integer id) {
		...
		try {
			...
			throw new IntegridadeDadosException("Não é possível excluir um cliente porque há pedidos relacionados.");
		}
	}
	...
	public Cliente fromDTO (NewClienteDTO objDTO) {
		Cliente cli =  new Cliente(null, objDTO.getNome(), objDTO.getEmail(), objDTO.getNi(), TipoCliente.toEnum(objDTO.getTipo()), pwdEncoder.encode(objDTO.getSenha()));
